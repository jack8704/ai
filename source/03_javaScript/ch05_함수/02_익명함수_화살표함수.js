...
funVar();
funVar = () => {
    console.log('2. 매개변수가 없거나 2개이상인 화살표함수');
};
funVar();
funVar = i => {
...
funVar(10);
funVar = i => console.log('4. 매개변수가 하나고, 구현부가 한줄짜리 화살표함수 호출', i);
//funVar = (i) => {console.log('4. 매개변수가 하나고, 구현부가 한줄짜리 화살표함수 호출')}; 쓸수는 있으나 사용자들이 사용안하는 방법임
funVar(10);
funVar = i => i*i ;
